...
indicador_6 %>%
  ...
  # ggplot(tabla_6) +
  # aes(x = MES, y = `ORDENES DE PROTECCIÓN`, group=1) +
  # geom_line(fill="#D98CBC", colour="#D98CBC", size=1) + 
  #   geom_point(aes(x = MES, y = `ORDENES DE PROTECCIÓN`, group=1), fill="#D98CBC", colour="#D98CBC")+
  #   geom_line(aes(y=`MEDIDAS DE PROTECCIÓN`, group=1), colour="#C91682", fill="#C91682", size=1)+ 
  #   geom_point(aes(y=`MEDIDAS DE PROTECCIÓN`, group=1), colour="#C91682", fill="#C91682")+
  #   geom_line(aes(y=`MUJERES VÍCTIMAS DE VIOLENCIA DE GÉNERO`, group=1), colour="#7E3794", fill="#7E3794", size=1)+ 
  #   geom_point(aes(y=`MUJERES VÍCTIMAS DE VIOLENCIA DE GÉNERO`, group=1), colour="#7E3794", fill="#7E3794")+
  #   xlab("") + ylab("")+ 
...
ggplot(tabla_6) +
  aes(x = MES, y = `ORDENES DE PROTECCIÓN`, group=3) +
...
```{r, include=T, echo=F}
tabla_30 %>% datatable(filter="top", options = list(pageLength = 16))
ggplotly(gr30)
```
...
```{r, include=T, echo=F}
tabla_32 %>% datatable(filter="top", options = list(pageLength = 16))
ggplotly(gr32)
```
...
```{r, include=T, echo=F}
tabla_33 %>% datatable(filter="top", options = list(pageLength = 16))
ggplotly(gr33)
```
...
```{r, include=T, echo=F}
tabla_34 %>% datatable(filter="top", options = list(pageLength = 16))
ggplotly(gr34)
```
...
```{r, include=T, echo=F}
tabla_35 %>% datatable(filter="top", options = list(pageLength = 16))
ggplotly(gr35)
```
...
```{r, include=T, echo=F}
tabla_36 %>% datatable(filter="top", options = list(pageLength = 16))
ggplotly(gr36)
```
...
```{r, include=T, echo=F}
tabla_37 %>% datatable(filter="top", options = list(pageLength = 16))
...
```{r, include=T, echo=F}
tabla_38 %>% datatable(filter="top", options = list(pageLength = 16))
ggplotly(gr38)
```
...
```{r, include=T, echo=F}
tabla_39 %>% datatable(filter="top", options = list(pageLength = 16))
ggplotly(gr39)
...
```{r, include=T, echo=F}
tabla_40 %>% datatable(filter="top", options = list(pageLength = 16))
ggplotly(gr40)
```
