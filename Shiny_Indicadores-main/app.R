...
indicador_2 %>%
  ...
  Mes=factor(Mes,
             levels=c("Enero", "Febrero", "Marzo","Abril", "Mayo", "Junio","Julio", "Agosto",
                      "Septiembre", "Octubre","Noviembre", "Diciembre")))->indicador_2
...
indicador_3 %>% 
  ...
  pivot_longer(cols = 6:30,
               names_to = "Peritaje",
               values_to = "Total de peritajes")->indicador_3
...
Mes=factor(Mes,
           levels=c("Enero", "Febrero", "Marzo","Abril", "Mayo", "Junio","Julio", "Agosto",
                    "Septiembre", "Octubre","Noviembre", "Diciembre")))->indicador_4
...
# Indicador 7: ----------------------------------------------------------------#
indicador_7 <- read_excel("indicadores_fiscalia.xlsx", sheet = "Ind 7", 
                          col_types = c("text", "numeric", "text", "numeric", "numeric", 
                                        "numeric", "skip", "skip", "skip", "skip"))%>% suppressWarnings()
...
indicador_7 %>% 
  ...
  summarise(`Total de mujeres víctimas de violencia de género atendidas`=sum(`Total de mujeres víctimas de violencia de género atendidas`),
            `Total de mujeres víctimas de violencia de género que solicitaron una medida de protección sin tener una canalización formal`=sum(`Total de mujeres víctimas de violencia de género que solicitaron una medida de protección sin tener una canalización formal`),
            `Total de mujeres víctimas de violencia de género que solicitaron una orden de protección sin tener una canalización formal`=sum(`Total de mujeres víctimas de violencia de género que solicitaron una orden de protección sin tener una canalización formal`),
            `Línea base`=scales::percent(sum(`Total de mujeres víctimas de violencia de género que solicitaron una medida de protección sin tener una canalización formal` + `Total de mujeres víctimas de violencia de género que solicitaron una orden de protección sin tener una canalización formal`)
...
indicador_9 %>% 
  ...
  summarise(`Total de medidas de protección emitidas por violencia por razón de género vigentes`=sum(`Total de medidas de protección emitidas por violencia por razón de género vigentes`),
            ...
            `Línea base`=scales::percent(sum(`Medidas de protección emitidas por violencia por razón de género vigentes que fueron trabajadas`+ `Medidas de protección emitidas por violencia por razón de género que fueron notificadas efectiva y personalmente a la persona agresora`)/
...
indicador_18$`Causal: (violacion/ salud/ riesgo)`[indicador_18$`Causal: (violacion/ salud/ riesgo)`=="VIOLACION"]<- "Violación"
...
indicador_24 %>% 
  ...
  summarise(Actualizan=sum(Actualizan),
            ...
            `Línea base`=scales::percent(sum(Actualizan/Instancia), 0.1)) ->estatal_24

indicador_24 %>% 
  group_by(Año, Mes, Fecha, Municipio) %>% 
  summarise(Actualizan=sum(Actualizan),
            Instancia=sum(Instancia),
            `Línea base`=scales::percent(sum(Actualizan/Instancia), 0.1)) ->municipal_24
...
ui <- dashboardPage(
  ...
  dashboardHeader(title = tags$p("Indicadores AVGM" ,  style = "color = #fffff; font-size: 2rem"
                                 )
                  ,
    ...
    tabItems(
      ...
      tabItem(tabName = "Inicio",
        ...
        tabItem(tabName = "Ind1", 
              ...
              fluidRow(width=10, 
                    ...
                    box(
                         width=12,  
                         valueBox("73.4%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("71.4%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("70.8%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
                         br(), br(), br(),
                    sidebarLayout(
                      ...
                      mainPanel(dataTableOutput("t_1", height = "auto", width = "auto"),
      ...
      tabItem(tabName = "Ind2", 
              ...
              fluidRow(width=10, 
                       ...
                       box(
                         width=12,  
                         valueBox("11.1%%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("12.9%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("18.9%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
                         br(), br(), br(),
                         sidebarLayout(
                           sidebarPanel("Seleccione algunas características",
                                        selectInput(
      ...
      tabItem(tabName = "Ind3", 
              ...
              fluidRow(width=10, 
                       ...
                       box(
                         width=12,  
                         valueBox("52.9%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("52.1%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("49.5%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
                         br(), br(), br(),
                         sidebarLayout(
                           sidebarPanel("Seleccione algunas características",
                                        selectInput(
      ...
      tabItem(tabName = "Ind4", 
              ...
              fluidRow(width=10, 
                       ...
                       box(
                         width=12,  
                         valueBox("30.8", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("34.8%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("37%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
                         br(), br(), br(),
                         sidebarLayout(
                           sidebarPanel("Seleccione algunas características",
                                        selectInput(
      ...
      tabItem(tabName = "Ind6",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("76.6%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 3), # actualizar
                         valueBox("60.3%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 3), # actualizar
                         valueBox("55.3%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 3), # actualizar
                         valueBox("61.0%","Línea base 2019",  icon=icon("ellipsis"), color="light-blue", width = 3), # actualizar
      ...
      tabItem(tabName = "Ind7",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("25%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 3), # actualizar
                         valueBox("37%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 3), # actualizar
                         valueBox("50%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 3), # actualizar
                         valueBox("62%","Línea base 2019",  icon=icon("ellipsis"), color="light-blue", width = 3), # actualizar
      ...
      tabItem(tabName = "Ind9",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("86.9%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("101.8%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("101.1%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
      ...
      tabItem(tabName = "Ind10",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("85.8%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("92.5%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("102.0%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
      ...
      tabItem(tabName = "Ind11",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("97.3%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("95.3%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("103.2%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
      ...
      tabItem(tabName = "Ind12",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("7.8%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("0.3%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("1.8%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
      ...
      tabItem(tabName = "Ind13",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("99.9%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("99.7%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("95.1", "Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
      ...
      tabItem(tabName = "Ind16",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("37.9%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("42.7%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("33.3%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
                         br(), br(), br(),
                         sidebarLayout(
                           sidebarPanel("Seleccione algunas características",
                                        selectInput(
      ...
      tabItem(tabName = "Ind17",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("100%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 3), # actualizar
                         valueBox("100%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 3), # actualizar
                         valueBox("100%", "Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 3), # actualizar
                         valueBox("100%", "Línea base 2019",  icon=icon("ellipsis"), color="light-blue", width = 3), # actualizar
      ...
      tabItem(tabName = "Ind18",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("100%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 6), # actualizar
                         valueBox("100%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 6), # actualizar
      ...
      tabItem(tabName = "Ind19", 
              ...
              fluidRow(width=10, 
                       ...
                       box(
                         width=12,  
                         valueBox("99.1%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 6), # actualizar
                         valueBox("0%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 6), # actualizar
                         br(), br(), br(),
                         sidebarLayout(
                           sidebarPanel("Seleccione algunas características",
                                        selectInput(
      ...
      tabItem(tabName = "Ind20",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("79.8%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 3), # actualizar
                         valueBox("83.3%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 2), # actualizar
                         valueBox("40.2%", "Línea base 2020", icon=icon("wave-square"),color="maroon", width = 2), # actualizar
                         valueBox("73.5%", "Línea base 2019",  icon=icon("ellipsis"), color="light-blue", width = 2), # actualizar
                         valueBox("75.6%", "Línea base 2018", icon=icon("wave-square"),color="red", width = 3), # actualizar
      ...
      tabItem(tabName = "Ind21",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("100%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 6), # actualizar
                         valueBox("97.6%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 6),# actualizar
     ...
     tabItem(tabName = "Ind22",
             ...
             fluidRow(width=10,
                      ...
                      box(
                        width=12,
                        valueBox("100%", "Línea base 2020", icon=icon("equals"),color="fuchsia", width = 6), # actualizar
                        valueBox("100%", "Línea base 2019", icon=icon("wave-square"),color="purple", width = 6),# actualizar
      ...
      tabItem(tabName = "Ind24",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("7.4%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("6.4%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("5.0%", "Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
      ...
      tabItem(tabName = "Ind25",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("255.9%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("187.4%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("50%", "Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
      ...
      tabItem(tabName = "Ind26",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("60.7%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("69.0%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("85.7%", "Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
      ...
      tabItem(tabName = "Ind27",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("1,252", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("523", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("392","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
                         br(), br(), br(),
                         sidebarLayout(
                           sidebarPanel("Seleccione algunas características",
                                        selectInput(
      ...
      tabItem(tabName = "Ind28",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("83.0%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("50.8%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("92.4%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
                         br(), br(), br(),
                         sidebarLayout(
                           sidebarPanel("Seleccione algunas características",
                                        selectInput(
      ...
      tabItem(tabName = "Ind29",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("20.2%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("16.1%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("11.0%", "Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
      ...
      tabItem(tabName = "Ind30",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("29.4%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("23.4%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("30.6%", "Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
                         br(), br(), br(),
                         sidebarLayout(
                           sidebarPanel("Seleccione algunas características",
                                        selectInput(
      ...
      tabItem(tabName = "Ind32",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("645", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("942", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("1,065", "Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
      ...
      tabItem(tabName = "Ind33",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("10.5%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("93.3%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("66.7%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
                         br(), br(), br(),
                         sidebarLayout(
                           sidebarPanel("Seleccione algunas características",
                                        selectInput(
      ...
      tabItem(tabName = "Ind34",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("51.9%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("55.6%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("55.2%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
                         br(), br(), br(),
                         sidebarLayout(
                           sidebarPanel("Seleccione algunas características",
                                        selectInput(
      ...
      tabItem(tabName = "Ind35",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("31.6%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 3), # actualizar
                         valueBox("33.3%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 3), # actualizar
                         valueBox("36.4%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 3), # actualizar
                         valueBox("29.2%","Línea base 2019",  icon=icon("ellipsis"), color="light-blue", width = 3), # actualizar
      ...
      tabItem(tabName = "Ind36",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("100%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("100%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("100%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
                         br(), br(), br(),
                         sidebarLayout(
                           sidebarPanel("Seleccione algunas características",
                                        selectInput(
      ...
      tabItem(tabName = "Ind37",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("100%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("96.4%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("76.7%","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
      ...
      tabItem(tabName = "Ind38",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("92.7%%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("80.6%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("81.2","Línea base 2020",  icon=icon("ellipsis"), color="maroon", width = 4), # actualizar
                         br(), br(), br(),
                         sidebarLayout(
                           sidebarPanel("Seleccione algunas características",
                                        selectInput(
      ...
      tabItem(tabName = "Ind40",
              ...
              fluidRow(width=10,
                       ...
                       box(
                         width=12,
                         valueBox("-14.1%", "Línea base 2022", icon=icon("equals"),color="fuchsia", width = 4), # actualizar
                         valueBox("39.8%", "Línea base 2021", icon=icon("wave-square"),color="purple", width = 4), # actualizar
                         valueBox("-10.7%", "Línea base 2020", icon=icon("wave-square"),color="maroon", width = 4), # actualizar
...
# Indicador 1: -----------------------------------------------------------------  
  ...
  output$gr1 <-renderPlotly ({
    ...
    ind_1_reactive() %>% 
      group_by(Año, Mes, `Servicios forenses`, Periodo) %>% 
      summarise(`Total de servicios`= n(),
                `Servicios forenses aplicado`= sum(Aplicado, na.rm=t),
                `Línea base`=scales::percent(sum((`Servicios forenses aplicado`)/`Total de servicios`), 0.1)) %>% 
      mutate(text = paste("Año: ", Año,
                          "\nMes: ",  Mes,
                          "\nTotal: ", scales::comma(`Servicios forenses aplicado`), sep="")) %>%
      ggplot() +
      aes(x = Periodo, y = `Servicios forenses aplicado`, 
          colour = `Servicios forenses`, group=`Servicios forenses`, text=text) +
      geom_line(size = 1.5) + 
      geom_point(size = 3)+
      labs(x="", y="", title = "Indicador 1",
           color = "Servicios forenses") +
      theme_minimal()+   
      #facet_wrap(vars(AÑO))+
  ...
  output$t_1 <- renderDataTable ({
    ...
    ind_1_reactive() %>% 
      group_by(Año, Mes) %>% 
      summarise(`Total de servicios`= n(),
                `Servicios forenses aplicados`= sum(Aplicado, na.rm=T),
                `Línea base`=scales::percent(sum((`Servicios forenses aplicados`)/`Total de servicios`), 0.1))->tabla_1
  ...
  output$gr2 <-renderPlotly ({
    ...
    ind_2_reactive() %>% 
      ...
      summarise(`Total de dictámenes psicosociales`= sum(`Dictamen psicosocial (servicio)`, na.rm = t),
                `Dictámenes con participación familiar`= sum(`Oportuna identificación y entrevista a testigos (dictamen femi.)`, na.rm=t)) %>% 
      ...
      labs(x="", y="", title = "Indicador 2",
           color = "Total de dictámenes") +
      theme_minimal()+   
      #facet_wrap(vars(año))+
      scale_y_continuous(labels = scales::comma) +
      scale_color_manual(
        values = c(`Total de dictámenes psicosociales` = "#c91682",
                   `Dictámenes con participación familiar` = "#7e3794")) +
      theme(legend.position = "bottom")+
      theme(text=element_text(size=12,  family="Nutmeg-Light"),
            plot.title = element_text(family="Nutmeg-Light"),
  ...
  output$t_2 <- renderDataTable ({
    ...
    ind_2_reactive() %>% 
      ...
      summarise(`Total de dictámenes psicosociales`= sum(`Dictamen psicosocial (servicio)`, na.rm = t),
                `Dictámenes con participación familiar`= sum(`Oportuna identificación y entrevista a testigos (dictamen femi.)`, na.rm=t),
                `Línea base`=scales::percent(sum((`Dictámenes con participación familiar`)/`Total de dictámenes psicosociales`), 0.1))->tabla_2
  ...
  output$gr3 <-renderPlotly ({
    ...
    ind_3_reactive() %>% 
      ...
      summarise(`Peritajes a los cuales se aplicó la perspectiva de género`= sum(`Total de peritajes`, na.rm=t)) %>% 
      mutate(text = paste("Año: ", Año,
                          "\nMes", Mes,
  ...
  output$t_3 <- renderDataTable ({
    ...
    ind_3_reactive() %>% 
      #indicador_3 %>% 
      group_by(Año, Mes) %>%
      summarise(`Total de peritajes realizados en IJCF por violencia de género`= n(),
                `Peritajes a los cuales se aplicó la perspectiva de género`= sum(`Total de peritajes`, na.rm=t),
                `Línea base`=scales::percent(sum((`Peritajes a los cuales se aplicó la perspectiva de género`)/`Total de peritajes realizados en IJCF por violencia de género`), 0.1))->tabla_3
  ...
  output$gr4 <-renderPlotly ({
    ...
    ind_4_reactive() %>% 
      ...
      summarise(`Dictámenes con acreditación técnica`= sum(`Total de dictámenes`, na.rm=t)) %>% 
      mutate(text = paste("Año: ", Año,
                          "\nMes: ",  Mes,
  ...
  output$t_4 <- renderDataTable ({
    ...
    ind_4_reactive() %>% 
      ...
      group_by(Año, Mes) %>%
      summarise(`Total de peritajes realizados`= n(),
                `Total de peritajes realizados conforme a lineamientos del IJCF`= sum(`Total de peritajes`, na.rm=t),
                `Línea base`=scales::percent(sum((`Total de peritajes realizados conforme a lineamientos del IJCF`)/`Total de peritajes realizados`), 0.1))->tabla_4
   ...
   ind_6_reactive() %>%
    #indicador_6 %>% 
      ...
      summarise(`Mujeres víctimas de violencia de género`=sum(`Mujeres víctimas de violencia de género`, na.rm=T),
                ...
                `Línea base`=scales::percent(sum((`Órdenes de protección`+`Medidas de protección`)/`Mujeres víctimas de violencia de género`), 0.1)) ->tabla_6
  ...
  output$t_17 <- DT::renderDataTable ({
    ...
    ind_17_reactive() %>%
      ...
      group_by(Año, Mes) %>%
      summarise(`Total de mujeres víctimas de violación o abuso sexual canalizadas al sector salud`= n(),
                `Total de mujeres víctimas de violación o abuso sexual que fueron atendidas en salud una vez canalizadas en fiscalía`= n(),
                `Línea base`=scales::percent((`Total de mujeres víctimas de violación o abuso sexual que fueron atendidas en salud una vez canalizadas en fiscalía`)/(`Total de mujeres víctimas de violación o abuso sexual canalizadas al sector salud`), 0.1))->tabla_17
  ...
  output$gr18 <-renderPlotly ({
    ...
    ind_18_reactive() %>%
      #indicador_18 %>%
      group_by(Año, Mes, Periodo, Rango, `Causal: (violacion/ salud/ riesgo)`) %>%
  ...
  output$t_18 <- DT::renderDataTable ({
    ...
    ind_18_reactive() %>%
      ...
      group_by(Año, Mes) %>%
      summarise(`Total de mujeres víctimas de violación que recibieron el procedimiento`= n(),
                `Total de mujeres víctimas de violación solicitantes del procedimiento`= n(),
                `Línea base`=scales::percent((`Total de mujeres víctimas de violación que recibieron el procedimiento`)/(`Total de mujeres víctimas de violación solicitantes del procedimiento`), 0.1))->tabla_18
  ...
  output$gr19 <-renderPlotly ({
    ...
    ind_19_reactive() %>% 
    # indicador_19 %>% 
      group_by(Año, Mes,Periodo, Rango, `Causal: (salud/riesgo)`) %>% 
      summarise(`Total de mujeres que de conformidad con las causales legales recibieron el procedimiento de ile`= sum(`¿Se realizó el procedimiento? (sí/no)`)) %>% 
      mutate(text = paste("Año: ", Año,
                          "\nMes: ", Mes,
  ...
  output$t_19 <- DT::renderDataTable ({
    ...
    ind_19_reactive() %>% 
      ...
      summarise(`Total de mujeres que solicitaron el procedimiento de interrupción legal del embarazo`= n(),
                ...
                `Línea base`=scales::percent((`Total de mujeres que de conformidad con las causales legales recibieron el procedimiento de ile`)/(`Total de mujeres que solicitaron el procedimiento de interrupción legal del embarazo`), 0.1))->tabla_19
    ...
    # indicador_20 %>% 
      ...
      scale_color_manual(
        values = c(
          ...
          `Violencia sexual`= "#a544ff",
          `Violencia económica / patrimonial`= "#e32964",
          `Abandono y/o negligencia`= "#597dff")) +
  ...
  output$t_20 <- DT::renderDataTable ({
    ...
    ind_20_reactive() %>% 
      ...
      summarise(`Total de mujeres víctimas de violencia sexual y/o familiar atendidas en el sector salud`= n(),
                ...
                `Línea base`=scales::percent((`Total de mujeres atendidas por violencia sexual y/o familiar notificadas al mp/fiscalía`)/(`Total de mujeres víctimas de violencia sexual y/o familiar atendidas en el sector salud`), 0.1))->tabla_20
  ...
  output$t_21 <- DT::renderDataTable ({
    ...
    ind_21_reactive() %>% 
      ...
      summarise(`Total de unidades en condiciones óptimas para realizar ILE/IVE` = sum(`Se cuenta con equipo y material para procedimiento ile/ive: (si/no)`),
                ...
                `Línea base`=scales::percent((`Total de unidades en condiciones óptimas para realizar ILE/IVE`)/(`Total de unidades de segundo y tercer nivel en condiciones óptimas para realizar el procedimiento ive e ile`), 0.1))->tabla_21
  ...
  output$t_22 <- DT::renderDataTable ({
    ...
    ind_22_reactive() %>% 
      ...
      summarise(`Total de personal de salud que atiende ILE/IVE capacitado`= n(),
                ...
                `Línea base`=scales::percent((`Total de personal de salud que atiende ILE/IVE capacitado`)/(`Total de personal de salud que atiende ILE/IVE`), 0.1))->tabla_22
  ...
  output$gr24 <-renderPlotly ({
    ...
    ind_24_reactive() %>%
      ...
      summarise(Actualizan=sum(Actualizan),
                Instancia=sum(Instancia),
                `Línea base`=scales::percent(sum(Actualizan/Instancia), 0.1)) %>% 
      pivot_longer(names_to = "Clasificación",
                   values_to = "Total",
                   cols=c("Actualizan",
                          "Instancia")) %>% 
  ...
  output$gr25 <-renderPlotly ({
    ...
    ind_25_reactive() %>%
      ...
      summarise(`Personal responsable de la actualización de datos`=sum(`Personal responsable de la actualización de datos`),
                ...
                `Línea base`=scales::percent(sum(`Personas debidamente capacitadas de alimentar BANAVIM`/`Personal responsable de la actualización de datos`), 0.1))%>% 
      pivot_longer(names_to = "Clasificación",
                   values_to = "Total",
  ...
  output$gr26 <-renderPlotly ({
    ...
    #indicador_26 %>% 
      ...
      summarise(Actualización=sum(Actualización),
                `Línea base`=scales::percent(sum(Actualización/7), 0.1)) %>% 
      pivot_longer(names_to = "Clasificación",
                   values_to = "Total",
  ...
  output$t_26 <- renderDataTable ({
    ...
    ind_26_reactive() %>%
      ...
      summarise(`Instancias que sí actualización`=sum(Actualización),
                ...
                `Línea base`=scales::percent(sum(Actualización/`Total de instancias estatales responsables`), 0.1)) -> tabla_26
  ...
  output$gr27 <-renderPlotly ({
    ...
    ind_27_reactive() %>%
      ...
      summarise(`Número de casos analizados`=sum(`Número de casos analizados`),
                ...
                `Línea base`=scales::percent(sum(`Número de casos analizados`/`Total opiniones técnicas`), 0.1)) %>% 
      pivot_longer(names_to = "Clasificación",
                   values_to = "Total",
  ...
  output$t_27 <- renderDataTable ({
    ...
    #ind_27_reactive() %>%
      ...
      summarise(`Línea base`=(Feminicidio + Desaparición)) -> tabla_27
  ...
  output$gr28 <-renderPlotly ({
    ...
    ind_28_reactive() %>%
      ...
      summarise(`Mujeres que realizan una denuncia por el delito de violacion`=sum(`Mujeres que realizan una denuncia por el delito de violacion`, na.rm=T),
                ...
                `Línea base`=scales::percent(sum((`Mujeres que realizan una denuncia por el delito de violacion`+ `Mujeres que realizan una denuncia por el delito de violencia familiar`)/`Mujeres atendidas en el CJM`), 0.1)) %>% 
      pivot_longer(names_to = "Clasificación",
                   values_to = "Total",
  ...
  output$t_29 <- renderDataTable ({
    ...
    #   #indicador_29 %>% 
      ...
      summarise(Iniciada=sum(Iniciada, na.rm=T),
                ...
                `Línea base`=scales::percent(sum((`Casos denunciados por violencia por razón de género que llegan a la etapa de judicialización`)/
  ...
  output$gr30 <-renderPlotly ({
    ...
    ind_30_reactive() %>%
      ...
      summarise(`Total de sentencias`=n(),
                `Línea base`=scales::percent(sum(`Total de sentencias`/n()))) %>% 
      pivot_longer(names_to = "Clasificación",
                   values_to = "Total",
  ...
  output$t_30 <- renderDataTable ({
    ...
    ind_30_reactive() %>%
      ...
      summarise(`Total de sentencias`=sum(`Año de sentencia`, na.rm = T),           
                ...
                `Línea base`=scales::percent(sum(`Total de sentencias`/n()), 0.1)) -> tabla_30
  ...
  output$gr34 <-renderPlotly ({
    ...
    ind_34_reactive() %>%
      ...
      summarise(`Número de casos de localización`=sum(`Número de casos de localización`),
                ...
                `Línea base`=scales::percent(sum((`Número de casos de localización`)/`Número de casos de aplicación a cabalidad del Protocolo Alba`), 0.1)) %>% 
      pivot_longer(names_to = "Clasificación",
                   values_to = "Total",
                   cols=4:6) %>% 
      mutate(text = paste("Año: ", Año,
  ...
  output$t_34 <- renderDataTable ({
    ...
    ind_34_reactive() %>%
      ...
      summarise(`Número de casos de localización`=sum(`Número de casos de localización`),
                `Número de casos de búsqueda`=sum(`Número de casos de búsqueda`),
                `Número de casos de aplicación a cabalidad del protocolo alba`=sum(`Número de casos de aplicación a cabalidad del Protocolo Alba`),
                `Línea base`=scales::percent(sum(`Número de casos de aplicación a cabalidad del Protocolo Alba`/(`Número de casos de localización`+ `Número de casos de búsqueda`)), 0.1)) -> tabla_34
  ...
  output$gr35 <-renderPlotly ({
    ...
    ind_35_reactive() %>%
      ...
      summarise(`Cédulas de difusión activas`=sum(`Cédulas de difusión activas`),
                ...
                `Línea base`=scales::percent(sum((`Cédulas de difusión activas`)/`Total de cédulas de difusión emitidas`), 0.1)) %>% 
      pivot_longer(names_to = "Clasificación",
                   values_to = "Total",
  ...
  output$gr36 <-renderPlotly ({
    ...
    ind_36_reactive() %>%
      ...
      summarise(`Número de casos en los que se activa, de conformidad con la normatividad y en el tiempo establecido el protocolo de la Alerta Amber`=sum(`Número de casos en los que se activa, de conformidad con la normatividad y en el tiempo establecido el protocolo de la Alerta Amber`),
                ...
                `Línea base`=scales::percent(sum((`Número de casos en los que se activa, de conformidad con la normatividad y en el tiempo establecido el protocolo de la Alerta Amber`)/`Total de casos de desaparición de niñas y adolescentes`), 0.1)) %>% 
      pivot_longer(names_to = "Clasificación",
                   values_to = "Total",
                   cols=3:4) %>% 
      mutate(text = paste("\nPeriodo: ",  Trimestre,
  ...
  output$gr38 <-renderPlotly ({
    ...
    ind_38_reactive() %>%
      ...
      summarise(`Casos de desaparición denunciados`=sum(`Casos de desaparición denunciados`),
                ...
                `Línea base`=scales::percent(sum((`Total de casos resueltos en etapa de investigación`)/`Casos de desaparición denunciados`), 0.1))%>% 
      pivot_longer(names_to = "Clasificación",
                   values_to = "Total",
  ...
  output$gr39 <-renderPlotly ({
    ...
    ind_39_reactive() %>%
      ...
      summarise(`Casos de desaparición que reciben seguimiento por parte de Protocolo Alba`=sum(`Casos de desaparición que reciben seguimiento por parte de Protocolo Alba`),
                ...
                `Línea base`=scales::percent(sum((`Casos de desaparición que reciben seguimiento por parte de Protocolo Alba`)/`Total de casos de desaparición denunciados`), 0.1)) %>% 
      pivot_longer(names_to = "Clasificación",
                   values_to = "Total",
    ...
    ind_40_reactive() %>%
      ...
      summarise(`Homicidio culposo`=sum(`Homicidio culposo`),
                ...
                Total=sum(`Homicidio culposo`+ `Homicidio doloso`+
                            `Accidente`+ `Feminicidio`+
                            `Suicidio`+ `El que resulte`)) %>% 
      mutate(`Línea base` = scales::percent((Total - lag(Total))/lag(Total),0.1))-> tabla_40
